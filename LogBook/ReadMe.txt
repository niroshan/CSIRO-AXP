========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : LogBook
========================================================================


AppWizard has created this LogBook application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your LogBook application.
...
res\LogBook.ico
    ...
    icon is included by the main resource file LogBook.rc.
...
LogBookDlg.h, LogBookDlg.cpp - the dialog
    These files contain your CLogBookDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in LogBook.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CLogBookDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named LogBook.pch and a precompiled types file named StdAfx.obj.
